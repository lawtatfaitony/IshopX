...
$(function () {
    ...
    uploader = WebUploader.create({
        ...
        // 文件接收服务端。
        server: '/Utilities/UpLoadProcess',    // '@Url.Action("UpLoadProcess", "Utilities")',
    ...
    uploader.on('fileQueued', function (file) {
        // 初始化以后添加 参数传入 
        uploader.options.formData.SubPath = 'Shoplogo';  //设置SubPath
        uploader.options.formData.Prefix = 'Shoplogo_';
    ...
    uploader.on('uploadSuccess', function (file, response) {
        console.log("图片url:" + response.filePath);
        $("#ShopLogo").val(response.filePath);
