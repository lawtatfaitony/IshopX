...
namespace Ishop
{
    public class BundleConfig
    {
        ...
        private static void RegisterLayout(BundleCollection bundles)
        {
            ...
            // plugins | bootstrap-treeview
            bundles.Add(new ScriptBundle("~/AdminLTE/plugins/bootstrap-treeview/js").Include(
                                        "~/AdminLTE/plugins/bootstrap-treeview/js/bootstrap-treeview.js"));

            bundles.Add(new StyleBundle("~/AdminLTE/plugins/bootstrap-treeview/css").Include(
                                        "~/AdminLTE/plugins/bootstrap-treeview/css/bootstrap-treeview.css"));
            ...
            bundles.Add(new StyleBundle("~/AdminLTE/plugins/font-awesome/css").Include(
                                        "~/AdminLTE/plugins/font-awesome/css/font-awesome.css"));
            ...
            bundles.Add(new ScriptBundle("~/AdminLTE/plugins/jquery/js").Include(
                                         "~/Scripts/jquery-{version}.js"));  //"~/AdminLTE/plugins/jquery/js/jQuery-{version}.js")); bug:同时出现多个版本
            ...
            // plugins | jquery.validate.unobtrusive
            ...
            //                             "~/AdminLTE/jquery.validate.unobtrusive.js"));

            // plugins | jvectormap
            bundles.Add(new ScriptBundle("~/AdminLTE/plugins/jvectormap/js").Include(
                                         "~/AdminLTE/plugins/jvectormap/js/jquery-jvectormap-1.2.2.js",
            ...
            bundles.Add(new ScriptBundle("~/AdminLTE/plugins/bootstrap-wysiwyg/js").Include(
                                        "~/AdminLTE/plugins/bootstrap-wysiwyg/js/bootstrap-wysiwyg-ext.js",
                                        "~/AdminLTE/plugins/bootstrap-wysiwyg/google-code-prettify/prettify.js",
                                         "~/AdminLTE/plugins/bootstrap-wysiwyg/js/bootstrap-wysiwyg-ini.js",
                                        "~/AdminLTE/plugins/bootstrap-wysiwyg/js/jquery.hotkeys.js"));

            bundles.Add(new StyleBundle("~/AdminLTE/plugins/bootstrap-wysiwyg/css").Include(
               "~/AdminLTE/plugins/bootstrap-wysiwyg/css/Custom.css",
                "~/AdminLTE/plugins/bootstrap-wysiwyg/google-code-prettify/prettify.css"));  // index.css
            ...
            // plugins |  | MainJS
            bundles.Add(new ScriptBundle("~/js/MainJS").Include("~/js/Main.js", "~/js/Info/IPstatitics.js"));
            ...
            bundles.Add(new StyleBundle("~/Content/webuploader").Include(
                 "~/webuploader/CSS/webuploader.css", "~/webuploader/CSS/style.css" ));
            bundles.Add(new ScriptBundle("~/Scripts/webuploader").Include( "~/webuploader/Script/webuploader.js", "~/webuploader/Script/WebUploaderFun.js" ));

            
            //plugins | TreeMenuItem
            bundles.Add(new ScriptBundle("~/js/TreeMenuItem").Include("~/js/TreeMenuItem.js"));
           
            //plugins | bootstrap-dialog
            bundles.Add(new ScriptBundle("~/AdminLTE/plugins/bootstrap-dialog/js").Include("~/AdminLTE/plugins/bootstrap-dialog/js/bootstrap-dialog.js"));
            bundles.Add(new StyleBundle("~/AdminLTE/plugins/bootstrap-dialog/css").Include("~/AdminLTE/plugins/bootstrap-dialog/css/bootstrap-dialog.css"));

            // plugins | Prodcate
            bundles.Add(new ScriptBundle("~/js/ProdCate").Include(
                                         "~/js/ProdCate/ProductCate.js",
                                         "~/js/ProdCate/ProdcateProp.js"));

            // plugins | LayerUI
            bundles.Add(new ScriptBundle("~/js/LayerUI/mobile").Include(
                                         "~/js/LayerUI/mobile/layer.js"));

            // plugins | LayerUI for PC
            bundles.Add(new ScriptBundle("~/js/LayerUI/PC").Include(
                                         "~/js/LayerUI/layer.js"));

            // plugins | ShoppingCar
            bundles.Add(new ScriptBundle("~/js/Order/ShoppingCart").Include(
                                         "~/js/Order/ShoppingCart.js"));

            // plugins | tbTrade
            bundles.Add(new StyleBundle("~/AdminLTE/plugins/tbTrade").Include(
                                        "~/AdminLTE/plugins/tbTrade/base.css")); 
