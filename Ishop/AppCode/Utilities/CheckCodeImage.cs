...
namespace Ishop.AppCode.Utilities
{
    ...
    public static class CreateCheckCodeImage
    {
        ...
        public static MemoryStream Production(string StrCode)
        {
            ...
            Bitmap image = new Bitmap((int)System.Math.Ceiling(StrCode.Length * 16.5), 30);
            ...
            try
            {
                ...
                //生成验证字符  
                Font font = new System.Drawing.Font("Freestyle Script", 16, (System.Drawing.FontStyle.Bold | System.Drawing.FontStyle.Italic));
