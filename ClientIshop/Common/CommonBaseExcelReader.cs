...
namespace Common
{
    public partial class CommonBase
    {
        ...
        public static DataTable ReadExcel(string filePath,bool useHeaderRow)
        {
            ...
            using (var stream = File.Open(filePath, FileMode.Open, FileAccess.Read))
            {
                ...
                { 
                    ...
                    var configuration = new ExcelDataSetConfiguration { ConfigureDataTable = tableReader => new ExcelDataTableConfiguration { UseHeaderRow = useHeaderRow } };
                    try
                    {
                    ...
                    {
                        string loggerline = $"[FUNC::CommonBase.ReadExcel][EXCEPTION]{e.Message}";
